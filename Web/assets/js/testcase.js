var TestCase = AC.Class({
    ...
    __setup: function(j, k) 
    {
        ...
        h = new AC.Flow.Ambient(this.mask(), j + k + "_###.png", j + k + "_manifest.json", j + k + "_keyframe.png", {autoplay: true, endState: j + k + "_endframe.png", fps: 24, continuous:true });
        this.setFlow(h);
