...
AC.Detector = {getAgent: function() {
        ...
        var l = k || this.getAgent(), h = this.isMobile(l), j, i, g;
        if (h) {
    ...
    },_iOSVersion: null,iOSVersion: function() {
        ...
        return false
    },_isQTInstalled: undefined,isQTInstalled: function() {
        ...
        return false
    },_svgAsBackground: null,svgAsBackground: function(f) {
    ...
    },_style: null,_prefixes: null,_preFixes: null,_css: null,isCSSAvailable: function(i) {
        if (!this._style) {
        ...
        return false
    },_supportsThreeD: false,supportsThreeD: function() {
        try {
    ...
    },_hasGyro: null,_testingForGyro: false,hasGyro: function() {
    ...
    },_isiPadWithGyro: null,isiPadWithGyro: function() {
        if (this._isiPadWithGyro === false || !this.isiPad()) {
            return false
        } else {
            return this._isiPadWithGyro = this.hasGyro()
        }
    },_hasLocalStorage: null,hasLocalStorage: function() {
        ...
        return this._hasLocalStorage
    },_hasSessionStorage: null,hasSessionStorage: function() {
        ...
        return this._hasSessionStorage
    },_hasCookies: null,hasCookies: function() {
